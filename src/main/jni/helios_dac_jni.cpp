...
Java_dev_defvs_HeliosDacNative_openDevices(JNIEnv* env, jobject obj) {
    return heliosDacInstance.OpenDevices();
}

extern "C" JNIEXPORT jint JNICALL
Java_dev_defvs_HeliosDacNative_closeDevices(JNIEnv* env, jobject obj) {
    return heliosDacInstance.CloseDevices();
}

extern "C" JNIEXPORT jint JNICALL
Java_dev_defvs_HeliosDacNative_getStatus(JNIEnv* env, jobject obj, jint devNum) {
    return heliosDacInstance.GetStatus(devNum);
}

extern "C" JNIEXPORT jint JNICALL
Java_dev_defvs_HeliosDacNative_getFirmwareVersion(JNIEnv* env, jobject obj, jint devNum) {
    return heliosDacInstance.GetFirmwareVersion(devNum);
}

extern "C" JNIEXPORT jint JNICALL
Java_dev_defvs_HeliosDacNative_getName(JNIEnv* env, jobject obj, jint devNum, jbyteArray name) {
...
extern "C" JNIEXPORT jint JNICALL
Java_dev_defvs_HeliosDacNative_setName(JNIEnv* env, jobject obj, jint devNum, jstring name) {
...
extern "C" JNIEXPORT jint JNICALL
Java_dev_defvs_HeliosDacNative_writeFrame(JNIEnv* env, jobject obj, jint devNum, jint pps, jbyte flags, jobjectArray pointArray, jint numOfPoints) {
...
extern "C" JNIEXPORT jint JNICALL
Java_dev_defvs_HeliosDacNative_stop(JNIEnv* env, jobject obj, jint devNum) {
    return heliosDacInstance.Stop(devNum);
}

extern "C" JNIEXPORT jint JNICALL
Java_dev_defvs_HeliosDacNative_setShutter(JNIEnv* env, jobject obj, jint devNum, jboolean level) {
    return heliosDacInstance.SetShutter(devNum, level);
}

extern "C" JNIEXPORT jint JNICALL
Java_dev_defvs_HeliosDacNative_setLibusbDebugLogLevel(JNIEnv* env, jobject obj, jint logLevel) {
    return heliosDacInstance.SetLibusbDebugLogLevel(logLevel);
}

extern "C" JNIEXPORT jint JNICALL
Java_dev_defvs_HeliosDacNative_eraseFirmware(JNIEnv* env, jobject obj, jint devNum) {
